"""
Tests for the imatrix_mse observer.

Covers the three bugs identified in code review:
1. get_global_min_max must not crash with importance on TENSOR_GROUP
2. importance must be reordered when actorder (g_idx) is active
3. observer must reject non-weight base_name
"""
...
class TestBasicFunctionality:
    ...
    def test_uniform_importance_matches_memoryless_mse(self):
        ...
        obs_imatrix = _make_observer(module_imatrix, strategy="channel")
